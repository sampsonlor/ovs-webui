...
func (h *Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if op.ID == "readContract" {
		respond(w, 200, map[string]any{"major": 1, "version": "1.6.0", "openapi_url": "/api/v1/openapi.json", "service_state": "availability-reported-by-runtime-and-domain-services", "request_domains": []string{"workspace", "management"}}, "application/json")
		return
	}
